...
{
    public class DangKiThucDonController : Controller
    {
        ...
        public ActionResult DangKiTheoNgay()
        {
            return View();
        }

        // GET: DangKiThucDon/Details/5
